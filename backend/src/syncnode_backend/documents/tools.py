...
def register_document_tools(registry) -> None:
    ...
    tools = [
        ...
        ToolDefinition(
            ...
            version=1,
            description="Generate a paragraph of text for a given topic. Pass topic= with the subject to write about.",
            ...
            arg_aliases={
                ...
                "body": "content",
                "paragraph": "content",
                # Common planner hallucinations for the topic field
                "content_prompt": "topic",
                "writing_prompt": "topic",
                "paragraph_topic": "topic",
                "paragraph_prompt": "topic",
                "goal": "topic",
                "description": "topic",
                "instruction": "topic",
                # Drop decorative fields the planner sometimes adds
                "target_document": "",
                "output_file": "",
                "document": "",
                "filename": "",
